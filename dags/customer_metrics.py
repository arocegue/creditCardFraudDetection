...
AIRBYTE_JOB_ID_LOAD_LABELED_TRANSACTIONS_RAW = os.environ.get("AIRBYTE_JOB_ID_LOAD_LABELED_TRANSACTIONS_RAW")
AIRBYTE_JOB_ID_LOAD_CUSTOMER_TRANSACTIONS_RAW = os.environ.get("AIRBYTE_JOB_ID_LOAD_CUSTOMER_TRANSACTIONS_RAW")
AIRBYTE_JOB_ID_RAW_TO_STAGING = os.environ.get("AIRBYTE_JOB_ID_RAW_TO_STAGING")
@dag(
